...
<body>
    ...
    <main>
        <section class="banner">
            ...
            <p><b>Descubra a beleza das nossas peças exclusivas.</b></p>
            <a href="#produtos" class="button">Comprar Agora</a>
        </section>
        ...
        <section id="produtos">
            ...
            <div class="produto-grade">
                <div class="produto">
                    <img src="imagens/anel-envelhecido.webp" alt="Anel Envelhecido de Prata">
                    <h3>Pulseira de ouro</h3>
                    <p>R$ 1.500,00</p>
                    <a href="produtos.php" class="button">Ver Mais</a>
                </div>
                <div class="produto">
                    <img src="imagens/anel-pedra-rosa.jpg" alt="Anel com Safira Rosa">
                ...
                <div class="produto">
                    <img src="imagens/pulseira-ouro.png" alt="Pulseira de Ouro">
                    <h3>Pulseira de Ouro</h3>
                    <p>R$ 800,00</p>
                    <a href="produtos.php" class="button">Ver Mais</a>
                </div>
                <div class="produto">
                    <img src="imagens/brinco-roxo.png" alt="Brincos com Safira Rosa">
                    <h3>Brincos com Safira Rosa</h3>
                    <p>R$ 6.300,00</p>
                    <a href="produtos.php" class="button">Ver Mais</a>
                </div>
                <div class="produto">
                    <img src="imagens/Anel Solitário de Diamante.jpg" alt="Anel Solitário de Diamante">
